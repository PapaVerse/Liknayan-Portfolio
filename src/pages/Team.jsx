...
const teamMembers = [
  { name: "Eron", role: "Full Stack Developer", experience: "8 years of experience in IT.", facebook: "https://www.facebook.com/estoresaaron013", portfolio: "#", image: "/images/Eron.jpg", skills: ["Laravel", "React", "Node.js", "MySQL"] },
  { name: "Drex", role: "Front-End Developer", experience: "2 years of experience in IT.", facebook: "https://www.facebook.com/deysqui", portfolio: "https://drex-portfolio.vercel.app/", image: "/images/Drex.jpg", skills: ["React", "TypeScript", "Tailwind", "Next.js"] },
  { name: "Val", role: "Front-End Developer", experience: "2 years of experience in IT.", facebook: "https://www.facebook.com/paulunicus/", portfolio: "https://my-portfolio-eight-coral-j4512g2pfn.vercel.app/", image: "/images/Val.jpg", skills: ["React", "JavaScript", "HTML/CSS", "Bootstrap"] },
  { name: "Ciara", role: "Graphic Layout Designer", experience: "2 years of experience in design.", facebook: "https://www.facebook.com/linsydee", portfolio: "#", image: "/images/Ciara.jpg", skills: ["Figma", "Canva", "CapCut", "Adobe Suite"] },
];
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 justify-center mt-6">
                {member.skills.map((skill) => (
                  <span key={skill} className="text-[10px] bg-gray-100 text-[#071A4A] px-3 py-1 rounded-full font-bold uppercase">{skill}</span>
                ))}
              </div>
      ...
      <AnimatePresence>
        {selectedMember && (
          <motion.div 
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-white/95 backdrop-blur-md z-50 flex items-center justify-center p-6"
          >
