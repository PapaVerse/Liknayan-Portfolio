...
import TeamHeader from "../components/teamsection/TeamHeader";
import TeamGrid from "../components/teamsection/TeamGrid";
import TeamMemberModal from "../components/teamsection/TeamMemberModal";
import TeamCultureBanner from "../components/teamsection/TeamCultureBanner";
  ...
  return (
    <section className="pt-32 pb-20 bg-white text-[#071A4A] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        {/* 1. Header Section */}
        <TeamHeader itemVariants={itemVariants} />

        {/* 2. Team Cards Grid */}
        <TeamGrid teamMembers={teamMembers} setSelectedMember={setSelectedMember} />

        {/* 3. Culture & CTA Banner */}
        <TeamCultureBanner />

      </div>

      {/* 4. Interactive Profile Modal Component */}
      <TeamMemberModal selectedMember={selectedMember} setSelectedMember={setSelectedMember} />
