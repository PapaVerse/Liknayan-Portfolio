    ...
    <section className="pt-32 pb-24 min-h-screen bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="mt-16 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            <h2 className="text-3xl font-bold text-[#071A4A]">
              Our Story
            </h2>
          ...
          {/* Team Highlight Card */}
          <div className="bg-[#071A4A] rounded-2xl p-8 text-white shadow-xl">
            ...
            <ul className="mt-6 space-y-4 text-gray-200">
              <li>
                🚀 1 Full Stack Developer - United Kingdom
              </li>

              <li>
                💻 2 Front-End Developers - Philippines
              </li>

              <li>
                🎨 1 Graphic Layout Designer - Philippines
              </li>
            </ul>
        ...
        <div className="mt-20 grid md:grid-cols-3 gap-8">
          ...
          <div className="p-8 rounded-2xl border border-gray-100 bg-white/70 backdrop-blur-md shadow-sm">
